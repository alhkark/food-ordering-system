...
public class PaymentRepositoryImpl implements PaymentRepository {
  ...
  public Payment save(Payment payment) {
    return paymentDataAccessMapper.toPayment(
        paymentJpaRepository.save(paymentDataAccessMapper.toPaymentEntity(payment)));
  }

  @Override
  public Optional<Payment> findByOrderId(UUID orderId) {
    return paymentJpaRepository.findByOrderId(orderId).map(paymentDataAccessMapper::toPayment);
  }
}
