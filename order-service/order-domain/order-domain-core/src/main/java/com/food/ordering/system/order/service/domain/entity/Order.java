...
public class Order extends AggregateRoot<OrderId> {
  ...
  public void approve() {
    if (orderStatus != OrderStatus.PAID) {
      throw new OrderDomainException("Order status is not in correct state for approved operation");
    }
  ...
  public void initCancel(List<String> failureMessages) {
    if (orderStatus != OrderStatus.PAID) {
      throw new OrderDomainException(
          "Order status is not in correct state for init cancel operation");
    }
