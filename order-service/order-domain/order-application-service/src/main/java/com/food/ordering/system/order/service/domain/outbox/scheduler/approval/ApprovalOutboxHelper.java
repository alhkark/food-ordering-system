...
public class ApprovalOutboxHelper {
  ...
  private final ArchiveApprovalOutboxRepository archiveApprovalOutboxRepository;
  ...
  @Transactional
  public void archiveApprovalOutboxRepository(
      List<OrderApprovalOutboxMessage> orderApprovalOutboxMessages) {
    archiveApprovalOutboxRepository.saveAll(orderApprovalOutboxMessages);
  }
  ...
  private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
    try {
      return jsonMapper.writeValueAsString(orderApprovalEventPayload);
